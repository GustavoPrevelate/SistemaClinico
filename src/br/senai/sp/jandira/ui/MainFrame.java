...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tituloLabel.setFont(new java.awt.Font("Monospaced", 1, 36)); // NOI18N
        ...
        buttonSair.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        ...
        buttonHome.setBackground(new java.awt.Color(255, 0, 51));
        ...
        buttonAgenda.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        buttonAgenda.setForeground(new java.awt.Color(0, 204, 255));
        ...
        buttonPacientes.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        buttonPacientes.setForeground(new java.awt.Color(0, 204, 255));
        ...
        buttonMedicos.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        buttonMedicos.setForeground(new java.awt.Color(51, 204, 255));
        ...
        buttonEspecialidades.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        buttonEspecialidades.setForeground(new java.awt.Color(0, 204, 255));
        ...
        buttonPlanosDeSaude.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        buttonPlanosDeSaude.setForeground(new java.awt.Color(0, 204, 255));
        ...
        panelHome.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "HOME", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Monospaced", 1, 24), new java.awt.Color(255, 0, 0))); // NOI18N
        ...
        jLabel1.setBounds(30, 50, 640, 64);

        jLabel2.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 204, 255));
        jLabel2.setText("Sistema para Agendamento de Consultas");
        panelHome.add(jLabel2);
        jLabel2.setBounds(40, 110, 420, 30);

        jLabel3.setFont(new java.awt.Font("Monospaced", 3, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 0, 0));
        jLabel3.setText("Entrar em contato:");
        panelHome.add(jLabel3);
        jLabel3.setBounds(40, 170, 230, 25);

        jLabel4.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        jLabel4.setText("Telefone: (11)97449-4479");
        panelHome.add(jLabel4);
        jLabel4.setBounds(40, 240, 240, 20);

        jLabel5.setFont(new java.awt.Font("Monospaced", 1, 14)); // NOI18N
        jLabel5.setText("E-mail: guprevelate2022@gmail.com");
        panelHome.add(jLabel5);
        jLabel5.setBounds(40, 210, 290, 20);
