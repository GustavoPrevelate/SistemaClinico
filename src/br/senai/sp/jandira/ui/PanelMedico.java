...
public class PanelMedico extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Médicos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Monospaced", 1, 18), new java.awt.Color(255, 0, 0))); // NOI18N
        setLayout(null);
        ...
        buttonExcluirMedico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/senai/sp/jandira/img/Deletar.png"))); // NOI18N
        ...
        buttonExcluirMedico.setBounds(700, 330, 40, 40);

        buttonEditarMedico.setBackground(new java.awt.Color(255, 255, 51));
        ...
        buttonEditarMedico.setBounds(760, 330, 40, 40);

        buttonAdicionarMedico.setBackground(new java.awt.Color(0, 255, 153));
        ...
        buttonAdicionarMedico.setBounds(820, 330, 40, 40);
